...
**Context:** Practical guide for the three Node.js scripts in `scripts/` that populate the Supabase database. Read before running or modifying pipeline scripts. For AI extraction details, see `docs/12_ai_extraction.md`. For deputies/senators strategy, see `docs/13_legislative_votes.md`.
