...
> **Status:** ⚠️ DEPRECIADO em 2026-08-24 · **Última atualização real:** 2026-06-29
> **Motivo:** Passo a passo de setup do Supabase que manda habilitar pgvector e cita Gemini como parte do banco a configurar — nenhum dos dois existe no schema atual.
> **Substituído por:** `docs/procedimentos/subir-ambiente-local.md`
