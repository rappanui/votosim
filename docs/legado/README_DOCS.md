...
> **Motivo:** Índice mestre que afirma Next.js 15, extração via Gemini/Groq/Cerebras/Mistral, `party_positions` populado e embeddings/pgvector — nenhuma dessas afirmações é verdadeira hoje.
