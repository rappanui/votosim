...
> **Motivo:** Rascunho anterior do schema de politicians/candidacies com coluna de embedding e pgvector como pré-requisito — nunca implementado — e cobre muito menos colunas que o `candidacies` atual (27).
