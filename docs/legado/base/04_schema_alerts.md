...
> **Status:** ⚠️ DEPRECIADO em 2026-08-24 · **Última atualização real:** 2026-08-23
> **Motivo:** A view `v_candidate_alerts` documentada aqui não cobre os três `alert_type` mais recentes (`incoerencia`, `divergencia_espectro`, `ressalva_evidencias`) — o próprio arquivo anota que a migração 11 (`docs/migracoes/11_sp0_foundation.sql`) substitui essa view. Descreve a versão anterior à correção do `AlertaBadge`.
> **Substituído por:** `docs/referencia/alertas.md`
...
-- Adicionado em 2026-08-23 (ALTER TYPE ... ADD VALUE, ver docs/referencia/schema-adicoes-sp0.md):
...
-- ressalva_evidencias=amarelo). Ver docs/referencia/schema-adicoes-sp0.md.
