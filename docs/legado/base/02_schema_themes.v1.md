...
> **Motivo:** O próprio changelog do v2 rotula esta versão como "10 temas, sem campos de questionário" — anterior à versão atual, que tem 14 temas com os campos de questionário.
