...
> **Motivo:** Especificação completa de tabelas de embeddings e cache de similaridade via pgvector — a tabela `theme_embeddings` nunca foi criada (HTTP 404 confirmado na consulta ao banco).
