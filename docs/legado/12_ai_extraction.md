...
> **Motivo:** Documenta o provedor de IA (Groq, modelo Llama 3.3 70B) usado por `extract-positions.ts` — modelo inexistente na API do Groq (`/v1/models`), e o script foi apagado na Fase A sem nunca ter escrito uma linha no banco.
