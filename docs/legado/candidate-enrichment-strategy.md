...
> **Motivo:** Já se autodeclarava superado desde 2026-08-20; ainda cita `extract-positions.ts` e `enrich-positions-groq.ts` (Groq) como Tier 1 e Tier 3, ambos apagados na Fase A.
