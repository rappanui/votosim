...
> **Motivo:** Já se autodeclarava aposentado desde 2026-08-20: uma auditoria de qualidade reprovou os 10 partidos com dados em `party_positions`. A tabela segue com 0 linhas hoje.
...
**Migration:** `docs/migracoes/10_party_positions.sql` — apply in Supabase SQL Editor before running the ingest.
