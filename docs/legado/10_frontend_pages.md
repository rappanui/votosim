...
> **Motivo:** Descreve um `CandidatoCard` com props que não existem, limiares de barra 80/60/40 e um fluxo `/perfil` → `/questionario` → `/revisao` deletado no v2. Errado em todos os eixos.
