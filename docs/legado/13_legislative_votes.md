...
> **Motivo:** Descreve `ingest-party-programs.ts` como parte da estratégia de dados para deputados e senadores — o script foi apagado na Fase A por ter como alvo `party_positions`, que tem 0 linhas.
