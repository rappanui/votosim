...
> **Motivo:** Documenta 8 das 18 colunas de `politician_positions` — faltam `justificativa`, `source_ids`, `neutro_motivo` e `coerencia_tema`, todas adicionadas pelo match v3 e pelo pipeline de pesquisa. Também cita o Gemini.
